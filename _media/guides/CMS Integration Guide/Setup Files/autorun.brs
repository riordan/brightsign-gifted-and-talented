...
' initialize networking
    Setup.networkingActive = Setup.networking.InitializeNetworkDownloads(loggingParameters.playbackLoggingEnabled$, loggingParameters.eventLoggingEnabled$, loggingParameters.stateLoggingEnabled$, loggingParameters.diagnosticLoggingEnabled$, loggingParameters.uploadLogFilesAtBoot$, loggingParameters.uploadLogFilesAtSpecificTime$, loggingParameters.uploadLogFilesTime$)

' setup logging
    Setup.logging.InitializeLogging(false, false, false, loggingParameters.diagnosticLoggingEnabled, loggingParameters.uploadLogFilesAtBoot, loggingParameters.uploadLogFilesAtSpecificTime, loggingParameters.uploadLogFilesTime%)
...
Function InitializeNetworkDownloads(playbackLoggingEnabled$ As String, eventLoggingEnabled$ As String, stateLoggingEnabled$ As String, diagnosticLoggingEnabled$ As String, uploadLogFilesAtBoot$ As String, uploadLogFilesAtSpecificTime$ As String, uploadLogFilesTime$ As String) As Boolean
...
' upload the first file    
    for each file in listOfLogFiles
		...
		ok = m.xfer.BindToInterface(m.logUploadsXfersBinding%)
		if not ok then stop
